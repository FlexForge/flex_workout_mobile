...
class ExerciseFiltersModal extends StatelessWidget {
  const ExerciseFiltersModal({required this.child, super.key});
...
class ExerciseFilters extends StatefulWidget {
  const ExerciseFilters({super.key});

  static const routePath = 'exercise_filters';
  static const routeName = 'exercise_filters';

  @override
  State<ExerciseFilters> createState() => _ExerciseSelectionFiltersState();
}

class _ExerciseSelectionFiltersState extends State<ExerciseFilters>
