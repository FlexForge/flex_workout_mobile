...
import 'package:flex_workout_mobile/features/workout/ui/components/swipe_action_circle.dart';
...
class WorkoutSupersetSectionView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    void addSet(WorkoutSupersetSectionModel sectionIndex) {
      ref.read(workoutControllerProvider.notifier).addSet(section);
    }
          ...
          children: [
            ...
            Padding(
              ...
              child: FlexButton(
                ...
                label: 'Add Set',
                icon: Symbols.add,
                backgroundColor: context.colors.backgroundQuaternary,
